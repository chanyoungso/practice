...
// Special Setting: Control (D5-7), Data(C0-3,B0-3)
#ifdef SPECIAL
#define DATA_DIR_H DDRC
#define DATA_DIR_L DDRB
#define DATABUS_H PORTC
#define DATABUS_L PORTB
#define CONTROL_DIR DDRD
#define CONTROLBUS PORTD
#define RS_BIT            0b00100000
#define RW_BIT            0b01000000
#define E_BIT             0b10000000
#endif
...
void LCD_init() {
    ...
    _delay_ms(INIT_MS);
    LCD_datapath();
    CONTROL_DIR |= ( RS_BIT | RW_BIT | E_BIT );
